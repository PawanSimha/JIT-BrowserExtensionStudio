...
declare module '#imports' {
  ...
  export { default as GradeBadge } from '../src/components/GradeBadge';
  export { default as Header } from '../src/components/Header';
  export { default as Layout } from '../src/components/Layout';
  export { default as LearningRoadmap } from '../src/components/LearningRoadmap';
  export { default as Sidebar } from '../src/components/Sidebar';
  export { default as TechLogo } from '../src/components/TechLogo';
  export { buildLayers, analyzeSecurity, analyzePerformance, getCategoryBreakdown } from '../src/utils/analysis';
  export { getBrandColor, getSlug, getLogoFallback } from '../src/utils/logos';
}
