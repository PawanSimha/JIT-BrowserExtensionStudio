          ...
          return (
            <div key={group.key} className="border border-surface-border rounded-lg overflow-hidden">
              <button
                ...
                className="w-full flex items-center gap-2 px-3 py-2 bg-surface-card hover:bg-surface-hover transition-colors text-left"
              >
                ...
                <span className="badge text-[9px] bg-surface-hover text-text-muted ml-auto">{group.techs.length}</span>
              </button>
              {isExpanded && (
                <div className="px-3 py-2 space-y-1">
                  {group.techs.map((tech) => (
                    ...
                    >
                      ...
                      <span className="text-2xs text-text-muted ml-auto">{Math.round(tech.confidence)}%</span>
                    </button>
                  ))}
                </div>
              )}
