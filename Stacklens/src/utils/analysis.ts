...
const categoryLayerMap: Record<string, { layer: string; color: string }> = {
  Frontend: { layer: 'Frontend', color: '#60A5FA' },
  'CSS Framework': { layer: 'Frontend', color: '#818CF8' },
  'UI Frameworks': { layer: 'Frontend', color: '#A78BFA' },
  'Build Tool': { layer: 'Build Tools', color: '#F59E0B' },
  Backend: { layer: 'Backend', color: '#34D399' },
  'Programming Language': { layer: 'Backend', color: '#6EE7B7' },
  Database: { layer: 'Backend', color: '#22D3EE' },
  CMS: { layer: 'Backend', color: '#2DD4BF' },
  'Static Site Generator': { layer: 'Frontend', color: '#93C5FD' },
  Hosting: { layer: 'Hosting & CDN', color: '#F97316' },
  CDN: { layer: 'Hosting & CDN', color: '#FB923C' },
  Caching: { layer: 'Hosting & CDN', color: '#FDA4AF' },
  'Reverse Proxies': { layer: 'Hosting & CDN', color: '#FCA5A5' },
  Analytics: { layer: 'Analytics', color: '#C084FC' },
  'Tag Manager': { layer: 'Analytics', color: '#D8B4FE' },
  'Marketing Automation': { layer: 'Marketing', color: '#F472B6' },
  RUM: { layer: 'RUM & Monitoring', color: '#E879F9' },
  Monitoring: { layer: 'RUM & Monitoring', color: '#F0ABFC' },
  Advertising: { layer: 'Advertising', color: '#FB7185' },
  Security: { layer: 'Security', color: '#EF4444' },
  Authentication: { layer: 'Security', color: '#F87171' },
  Payments: { layer: 'Payments', color: '#FBBF24' },
  'AI SDK': { layer: 'AI & SDKs', color: '#A78BFA' },
  'JavaScript Libraries': { layer: 'JavaScript Libraries', color: '#FBBF24' },
  PaaS: { layer: 'PaaS', color: '#38BDF8' },
  DevOps: { layer: 'DevOps', color: '#818CF8' },
  'E-commerce': { layer: 'E-commerce', color: '#F472B6' },
  Email: { layer: 'Email', color: '#FBBF24' },
  Miscellaneous: { layer: 'Miscellaneous', color: '#9CA3AF' },
  Fonts: { layer: 'Fonts', color: '#C084FC' },
  'Font Script': { layer: 'Fonts', color: '#A78BFA' },
  Map: { layer: 'Miscellaneous', color: '#9CA3AF' },
  'Video Players': { layer: 'Video Players', color: '#FB923C' },
};
